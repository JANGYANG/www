...
<title>Register Player Information</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>

<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
<link type="text/css" rel="stylesheet" href="<%=rootURL%>/assets/css/materialize.css"  media="screen,projection"/>
<link type="text/css" rel="stylesheet" href="<%=rootURL%>/assets/css/main.css"  media="screen,projection"/>
		
    
<script type="text/javascript" src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
	   
<script type="text/javascript" src="<%=rootURL %>/assets/js/materialize.min.js"></script>
<script type="text/javascript" src="<%=rootURL %>/assets/js/main.js"></script>
	   

<script type="text/javascript" src="<%=rootURL %>/assets/js/registerUserInfo.js"></script>
	  <style>
	  select{
	  display: inherit;
	  }
  ...
  <div class="container">
    <div class="row">
      <div class="col m6 offset-m3 s8 offset-s2">
        <img src="<%= rootURL %>/assets/img/logo_CI.png" style="width:100%;padding:30px">
      </div>
    </div>
  </div>
  <div class="container">

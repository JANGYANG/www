...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/assets/js/registerTeam.js"></script>
	<style>
		select {
			display: inherit;
		}
	...
	<div class="container">
		<div class="row">
			<div class="col m6 offset-m3 s8 offset-s2">
				<img src="<%=request.getContextPath() %>/assets/img/logo_CI.png" alt="LOGIN" title="BG"
					style="width: 100%">
			</div>
		</div>
	</div>
